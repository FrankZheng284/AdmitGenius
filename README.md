# AdmitGenius 留学申请助手系统

AdmitGenius 是一个智能留学申请助手系统，帮助用户完成留学申请流程。系统提供用户管理、AI文书生成与润色、学校推荐、论坛交流等核心功能。
...
4. **配置 OpenAI API 密钥（可选）：**
```properties
openai.api.key=openai.api.key=sk-fzOevL4E6Htk2cfYbEanLDP1Oc0PzHWL6P6ACLLfTR8Tsn2A
```
